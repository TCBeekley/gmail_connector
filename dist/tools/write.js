...
export function registerWriteTools(server) {
    server.registerTool("send_email", {
        description: "Send a plain-text email from the specified account. For replies, pass thread_id, in_reply_to (Message-Id of the parent), and references.",
        inputSchema: {
    ...
    server.registerTool("modify_labels", {
        description: "Add and/or remove labels on a message. Use list_labels to find label IDs. System labels include INBOX, UNREAD, STARRED, IMPORTANT, SPAM, TRASH.",
        inputSchema: {
            account: z.string().describe(ACCOUNT_DESC),
            message_id: z.string(),
